...
client.on('message', msg => {
  if (msg.content === '!!تسحيل') {
    msg.reply('انا العب دابوكا سيرفر');
  }
});
...
client.on('message', msg => {
  if (msg.content === '!!كلان') {
    msg.reply('اختر كلان speed او flight');
  }
});
...
client.on("message", message => {
 if (message.content === "!!مساعدة") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('Dabooka Bot')
      .setFooter('======================================================')
      .setFooter('اوامر الاعضاء')
	  .addField('!!رتب', `لمعرفة الرتب الي في السيرفر`)
      .addField('!!صورتي', `الافتار عن طريق المنشن`)
	  .addField('!!سيرفر', `يجبلك معلومات السيرفر`)
	  .addField('!!ملفي', `يجبلك الملف الشخصي حقك`)
	  .addField('!!حذف', `البوت يمسح  100 رسايل`)
	  .addField('!!قل', `البوت يكرر الكلام الي انت تقوله`)
	  .addField('!!اتصال', `يقلك كم بنق البوت`)
      .addField('!!مساعدة', `سيرفر الدعم`)
      .setFooter('======================================================')
	  .addField('-قطة', `يجبلك صورة بسه`)
...
client.on("message", message => {
 if (message.content === "!!مساعدة") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('يرجى كتابة !!مساعدة في السيرفر')  
      .addField('دابوكا بوت ', `  https://discord.gg/kC89XTq  `)
  message.author.send({embed});
...
const TOKEN = "NDA5MDI2MTUwNjU2OTAxMTMx.DXX56g.NrgH7CqUI9gW2NFrP0pquUykA5w";
...
var embed = new Discord.RichEmbed()
    ...
    msg.client.channels.get('411884549359009793').send(embed);
    msg.channel.send('تم تسجيل تذكرتك ويستم مراجعتها من قبل المسؤولين')
    msg.delete();
  }
});
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`---------------`);
  console.log(`Logged in as ${client.user.tag}!`);
  client.user.setGame(`I'm Dabooka There`,"http://google.com")
...
if (command == "اقتراح") {
    ...
    .setDescription(args.join(" "))
    .setFooter('© . :AG || Copyright')
    msg.client.channels.get('417238392414142465').send(embed);
    msg.channel.send('تم تسجيل اقتراحكم وسوف يتم مراجعته من قبل المسؤولين')
    msg.delete();
  }
});
...
client.on('message', msg => {
  if (msg.content === 'بوت') {
    msg.reply('مرحبًا ! كيف اقدر اساعدك');
  }
});
...
client.on('message', msg => {
  if (msg.content === 'سيرفر') {
    msg.reply('! اكتب ّايبي لرؤية السيرفر');
  }
});


client.on('message', msg => {
  if (msg.content === 'سباون') {
    msg.reply('احداثيات السباون هي X: 483 Y: 78 Z:-15');
  }
});
